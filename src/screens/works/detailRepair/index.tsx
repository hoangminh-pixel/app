  ...
  return (
    <BasePage edges={['bottom']} paddingHorizontal={0}>
      ...
      >
        ...
        {detail?.state.state === 'processing' && mediaResponse.length > 0 && (
          <Fragment>
            <SizeBox height={16} />
            <Section icon="photo" title="Kết quả thực hiện" marginTop={0} />
      ...
      {isDone && (
        <View style={styles.footer}>
          <Pressable style={styles.submitBtn} onPress={handleDoneJob}>
